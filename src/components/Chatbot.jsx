    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 bg-gradient-to-r from-blue-500 to-purple-600 text-white 
                   p-4 rounded-full shadow-2xl hover:shadow-blue-500/50 transition-all duration-300 
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-6 right-6 z-50 w-full max-w-md h-[600px] flex flex-col 
            ...
            <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
              {quickActions.map((action, index) => (
                <button
                  ...
                  className="px-3 py-1 bg-white/5 border border-white/20 text-white text-xs rounded-full 
          ...
          <div className="p-4 bg-gray-900/50 border-t border-white/10">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl 
